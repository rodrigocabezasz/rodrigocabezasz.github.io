...
Summary: Diseñando un esqueleto escalable con FastAPI, Streamlit y Docker para un sistema de dashboards de Control de Gestión reutilizable.

![Arquitectura del Framework]({static}/images/framework-arquitectura.jpg)
...
La estructura de carpetas inicial quedó definida de la siguiente manera:
...
En el próximo post, nos sumergiremos en el código del **backend**, construyendo el sistema de autenticación y los endpoints iniciales con FastAPI.
